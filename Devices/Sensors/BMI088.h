...
extern void BMI088_GPIO_init();
extern void BMI088_com_init();
extern void BMI088_delay_ms(uint16_t ms);
extern void BMI088_delay_us(uint16_t us);

#if defined(BMI088_USE_SPI)
extern void BMI088_ACCEL_NS_L();
extern void BMI088_ACCEL_NS_H();

extern void BMI088_GYRO_NS_L();
extern void BMI088_GYRO_NS_H();
...
extern uint8_t bmi088_accel_self_test();
extern uint8_t bmi088_gyro_self_test();
extern uint8_t bmi088_accel_init();
extern uint8_t bmi088_gyro_init();
...
extern uint32_t get_BMI088_sensor_time();
extern float get_BMI088_temperate();
extern void get_BMI088_gyro(int16_t gyro[3]);
extern void get_BMI088_accel(float accel[3]);


extern void BMI088_read_gyro_who_am_i();
extern void BMI088_read_accel_who_am_i();
