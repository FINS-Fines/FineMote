...
public:
    ...
    void SetTargetTorque(float targetTorque) {
        if (params.targetType != Motor_Ctrl_Type_e::Torque) {
            return;
        }
        target = targetTorque / params.torqueCoefficient;
    }
