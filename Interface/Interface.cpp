...
float pathTask2[4][7] = {
    ...
    {-1.12, 0, -0.25, -0.1, PI, 0, 2},
    {-1.12, 0, -1.83, -0.2, PI, 0, 3.5},
    {-1.12, 0, -1.88, 0, PI, 0, 0.7}//加工区
};
float pathTask3[3][7] = {
    {-1.75, -0.3, -1.92, 0, PI, 0, 1.5},
    {-1.915, 0, -1.75, 0.3, PI * 0.5f, 0, 1.5},
    {-1.915, 0, -1.1, 0, PI * 0.5f, 0, 1.8}//暂存区
};
float pathTask4[3][7] = {
...
float pathTask5[4][7] = {
    ...
    {-1.13, 0, -0.24, -0.1, PI, 0, 2},
    {-1.12, 0, -1.85, -0.2, PI, 0, 3.5},
    {-1.12, 0, -1.90, 0, PI, 0, 0.7}//加工区
};
float pathTask6[3][7] = {
    {-1.75, -0.3, -1.94, 0, PI, 0, 1.5},
    {-1.92, 0, -1.77, 0.3, PI * 0.5f, 0, 1.5},
    {-1.92, 0, -1.08, 0, PI * 0.5f, 0, 1.8}//暂存区
};
float pathTask7[3][7] = {
    {-1.93, 0, -0.32, 0.3, PI * 0.5f, 0, 1.5},
