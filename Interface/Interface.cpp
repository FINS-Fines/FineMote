...
float pathTask2[4][7] = {
    ...
    {-1.08, 0, -0.25, -0.1, PI, 0, 2},
    {-1.08, 0, -1.83, -0.2, PI, 0, 3.5},
    {-1.08, 0, -1.88, 0, PI, 0, 0.7}//加工区
};
float pathTask3[3][7] = {
    {-1.75, -0.3, -1.92, 0, PI, 0, 1.5},
    {-1.88, 0, -1.75, 0.3, PI * 0.5f, 0, 1.5},
    {-1.88, 0, -1.1, 0, PI * 0.5f, 0, 1.8}//暂存区
};
float pathTask4[3][7] = {
    // {-1.92, 0, -0.32, 0.3, PI * 0.5f, 0, 1.5},
    // {-1.75, 0.3, -0.15, 0, 0, 0, 1.5},
    // {-1.49, 0, -0.15, 0, 0, 0, 1.5}, //转盘
    {-1.88, 0, -0.34, 0.3, PI * 0.5f, 0, 1.5},
...
float pathTask5[4][7] = {
    ...
    {-1.09, 0, -0.24, -0.1, PI, 0, 2},
    {-1.08, 0, -1.85, -0.2, PI, 0, 3.5},
    {-1.08, 0, -1.90, 0, PI, 0, 0.7}//加工区
};
float pathTask6[3][7] = {
    {-1.75, -0.3, -1.94, 0, PI, 0, 1.5},
    {-1.88, 0, -1.77, 0.3, PI * 0.5f, 0, 1.5},
    {-1.88, 0, -1.08, 0, PI * 0.5f, 0, 1.8}//暂存区
};
float pathTask7[3][7] = {
    {-1.88, 0, -0.32, 0.3, PI * 0.5f, 0, 1.5},
...
void Task4(){
    ...
    if (cnt >= 4){
        ...
        // manipulatorCommand[26] = static_cast<uint8_t>(true);
...
//     {-0.5, -0.15, -0.15, 0, 0, 0, 1.5},
//     {-1.75, -0.3, -0.17, 0, 0, 0, 3},
//     {-1.91, 0, -0.34, -0.3, PI * 0.5, 0, 1.5},
//     {-1.91, 0, -1.09, 0, PI * 0.5f, 0, 2}//原料
// };
// float pathTaskFinal2[3][7] = {
//     {-1.91, 0, -1.75, -0.3, PI * 0.5f, 0, 1.5},
//     {-1.75, 0.3, -1.91, 0, PI, 0, 1.5},
//     {-1.11, 0, -1.88, 0, PI, 0, 2},//加工区
// };
// float pathTaskFinal3[4][7] = {
//     {-1.11, 0, -1.88, 0, 0, 0, 2},
//     {-1.11, 0, -0.25, 0.2, 0, 0, 3},
//     {-1.25, -0.2, -0.15, 0, 0, 0, 1.5},
//     {-1.52, 0, -0.15, 0, 0, 0, 1.5}, //转盘暂存
// };
...
//     {-1.11, 0, -1.88, 0, 0, 0, 2},
//     {-1.11, 0, -0.25, 0.2, 0, 0, 3},
//     {-1.25, -0.2, -0.17, 0, 0, 0, 1.5},
//     {-1.52, 0, -0.17, 0, 0, 0, 1.5}, //转盘暂存
// };
