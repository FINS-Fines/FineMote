...
//    index %= 3;
//  }
  BeepMusic::MusicChannels[0].Stop();
...
//
//RMD_L_40xx_v3<2> CFRMotor(TORQUE_2_SPEED, wheelControllers[0], 0x242);
//RMD_L_40xx_v3<2> CFLMotor(TORQUE_2_SPEED, wheelControllers[1], 0x244);
//RMD_L_40xx_v3<2> CBLMotor(TORQUE_2_SPEED, wheelControllers[2], 0x246);
//RMD_L_40xx_v3<2> CBRMotor(TORQUE_2_SPEED, wheelControllers[3], 0x248);
//
//RMD_L_40xx_v3<2> SFRMotor(TORQUE_2_POSITION, swerveControllers[0], 0x241);
//RMD_L_40xx_v3<2> SFLMotor(TORQUE_2_POSITION, swerveControllers[1], 0x243);
//RMD_L_40xx_v3<2> SBLMotor(TORQUE_2_POSITION, swerveControllers[2], 0x245);
//RMD_L_40xx_v3<2> SBRMotor(TORQUE_2_POSITION, swerveControllers[3], 0x247);
...
void Task4() {
  //里边本来是空的，现在是周时逸补充的内容
  float speed = remote.GetInfo().rightCol * 210.f;
  motor1.SetTargetSpeed(speed);
}
